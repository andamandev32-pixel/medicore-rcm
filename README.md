# MediClearing — ระบบบริหารวงจรรายได้โรงพยาบาล (RCM)
...
> **หน้าแรกของทั้ง 3 ชุดเป็นอินโฟกราฟิกตัวเดียวกัน** — `prfCoverage()` ใน `present-flows.js`
> บอกขอบเขตทั้งระบบในภาพเดียว (4 เส้นงาน · เส้นที่มี ★ คือส่วนที่เพิ่มใหม่)
> แก้ที่ฟังก์ชันเดียวแล้วเปลี่ยนครบทุก deck
>
