...
/* 8B ── ความเสี่ยงถูกเรียกเงินคืน ─────────────────────────
   วางต่อจาก "สองวงจร" โดยตั้งใจ — สองวงจรอธิบายว่าทำไมต้องตรวจก่อนส่ง
   หน้านี้อธิบายว่าทำไมการตรวจก่อนส่งอย่างเดียวไม่พอ ต้องเก็บสายหลักฐานไว้ด้วย
   เพราะรอบที่แพงที่สุดไม่ใช่รอบตีกลับ แต่คือรอบที่ถูกเรียกเงินคืนทีหลัง

   ⚠️ ตัวเลขทุกตัวในหน้านี้มาจากข่าวและเอกสารสาธารณะ ไม่ใช่ค่าสมมติ
      แหล่งอ้างอิงครบอยู่ในรายงาน doc/market-nonhis-claim-audit.html */
{
    /* k .88 — ที่ค่าเต็มแถวสุดท้ายของตาราง (เงินบำรุงติดลบ 400 แห่ง) ถูก .pr-body ตัดหายเงียบ ๆ
       จับได้จากภาพเรนเดอร์จริง ไม่ใช่จากการอ่านโค้ด — ถ้าจะเพิ่มเนื้อหาในหน้านี้ต้องลด k ตาม */
    k: .88,
    eyebrow: 'บริบทที่เปลี่ยนไป',
    title: 'รอบที่แพงที่สุดไม่ใช่รอบตีกลับ — แต่คือรอบที่ถูกเรียกเงินคืน',
    lead: 'ระหว่างที่หน่วยบริการกังวลเรื่องเบิกได้ไม่ครบ ฝั่งผู้จ่ายกำลังขยายอำนาจการตรวจสอบย้อนหลัง ' +
          'ซึ่งเป็นความเสี่ยงที่เกิดหลังจากเงินเข้าบัญชีไปแล้ว',
    body: `
    <div style="display:flex;flex-direction:column;gap:9px;height:100%">
        <div class="pr-grid pr-g3" style="flex:none">
            <div class="pr-card danger">
                <h3>สุ่มตรวจ 3% → ขยายผล 33 เท่า</h3>
                <div class="pr-kv">ปีงบ 2569 ใช้การสุ่มตรวจเวชระเบียนผู้ป่วยใน <b>3%</b>
                    เป็นเกณฑ์ประเมินงบทั้งก้อน — ถ้าพบข้อผิดพลาด
                    <b>หักจ่ายได้ถึง 20% หรือขยายผล 33 เท่า</b> ของกลุ่มตัวอย่าง</div>
            </div>
            <div class="pr-card danger">
                <h3>RW ตกหลังถูกตรวจ</h3>
                <div class="pr-kv">ผลการตรวจสอบหลังจ่ายระบุว่า
                    <b>กว่า 80% ของโรงพยาบาลในระบบบัตรทอง มีค่า RW หลัง audit
                    ต่ำกว่าก่อน audit</b> — ไม่ใช่ปัญหาของ รพ. ไม่กี่แห่ง</div>
            </div>
            <div class="pr-card danger">
                <h3>ผู้จ่ายมี AI ของตัวเอง</h3>
                <div class="pr-kv">สปสช. ลงทุน <b>24 ล้านบาท</b> พัฒนา AI ตรวจสอบการเบิกจ่าย
                    จับข้อมูลต้องสงสัยแบบ real-time และมีการใช้ AI-Audit
                    ตัดรหัสที่ไม่ถูกหลักเกณฑ์แล้วคำนวณ DRG ใหม่</div>
            </div>
        </div>

        <div class="pr-card stack" style="flex:1">
            <h3>สิ่งที่เกิดขึ้นในรอบปีที่ผ่านมา</h3>
            <table class="pr-table">
                <tr><th>เหตุการณ์</th><th>ความหมายต่อหน่วยบริการ</th></tr>
                <tr><td>บอร์ด สปสช. อนุมัติ <b>Audit 100%</b> ของ รพ.เอกชนที่รับผู้ป่วยบัตรทอง
                    และวางระบบตรวจเวชระเบียนผู้ป่วยในของทุกหน่วยบริการในปี 2569</td>
                    <td>สำหรับกลุ่มเอกชน ไม่ใช่การสุ่มอีกต่อไป</td></tr>
                <tr><td>กระทรวงสาธารณสุขและ <b>4 องค์กรแพทย์</b> ยื่นหนังสือค้านเกณฑ์การสุ่มตรวจ
                    พร้อมเสนอ 6 แนวทาง</td>
                    <td>ยืนยันว่านี่คือความกังวลอันดับต้นของหน่วยบริการ ไม่ใช่ประเด็นทางเทคนิค</td></tr>
                <tr><td>โรงพยาบาลสังกัด สธ. <b>เงินบำรุงติดลบ 400 แห่ง ขาดดุลรวม 12,218 ล้านบาท</b></td>
                    <td>ไม่มีสายป่านให้รองรับการถูกเรียกเงินคืนย้อนหลัง</td></tr>
            </table>
        </div>

        <div class="pr-note strong" style="flex:none">
            <strong>ผลต่อการออกแบบระบบ</strong> — การตรวจก่อนส่งช่วยให้ผ่านรอบแรก
            แต่ไม่ช่วยตอนถูกตรวจย้อนหลัง เพราะคำถามในวันนั้นไม่ใช่ “ระบบคิดว่าอย่างไร”
            แต่คือ <strong>“อ้างประกาศฉบับไหน ข้อไหน ณ วันให้บริการนั้น”</strong> ·
            ระบบจึงเลือกกฎตามวันที่รับบริการ กองทุน และประเภทบริการ (BR-01)
            และเก็บผลทุกข้อให้ย้อนกลับได้ถึงรหัสกฎ เวอร์ชัน และเอกสารต้นทาง (BR-03) —
            <strong>สายหลักฐานคือสิ่งที่ตอบผู้ตรวจได้ ไม่ใช่คะแนนความมั่นใจของแบบจำลอง</strong>
        </div>
    </div>`,
    foot: 'ตัวเลขในหน้านี้มาจากข่าวและเอกสารสาธารณะ ไม่ใช่ค่าสมมติ — แหล่งอ้างอิงครบอยู่ในรายงานวิเคราะห์ตลาด',
},
